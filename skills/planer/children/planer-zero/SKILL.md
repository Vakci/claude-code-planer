...
# PLANER-ZERO: Greenfield Project Planning (Child of PLANER)

> **Note:** This is a child skill of PLANER. It inherits shared phases (2, 3, 4) from the parent.
> - **Parent:** `~/.claude/skills/planer/SKILL.md`
> - **Shared Logic:** `~/.claude/skills/planer/shared/`
> - **Invoked by:** Parent PLANER when new/greenfield project is detected
